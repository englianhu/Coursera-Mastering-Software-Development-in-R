...
![](figure/04 Building Data Visualization Tools.png)
...
if (nrow(sys1) == 11 & nrow(sys2) == 8) {
  ...
  Sys.info = c(as.character(packageVersion('rmarkdown')), as.character(packageVersion('rsconnect')),  paste(as.character(lubridate::now('Asia/Tokyo')), 'JST🗾'))))
